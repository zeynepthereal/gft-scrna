...
\title{Formatting Instructions For I Can't Believe It's Not Better (ICBINB): Failure Modes of AI in Biology workshop at NeurIPS 2026}
...
Papers to be submitted to I Can't Believe It's Not Better (ICBINB): Failure Modes of AI in Biology workshop at NeurIPS 2026 must be prepared according to the
instructions presented here. Papers may only be up to {\bf eight} pages long (for full paper submission) and up to {four} pages long (for tiny paper submission), including figures. \textbf{Papers that exceed the page limit will not be reviewed (or in any other way considered) for presentation at the conference.}
Additional pages \emph{containing acknowledgments, references, checklist, and optional technical appendices} do not count as content pages. The authors must adhere to the Call for Papers on the workshop website: 
\begin{center}
  \url{https://neurips.cc}.
\end{center}

Below, we retain the other original instructions for NeurIPS 2026 Main Conference, which the workshop also adheres to. Tweaking the style files may be grounds for desk rejection.
